...
const PageNav = () => {
  return (
    <nav>
      ...
      <Button className={styles.link} component={NavLink}  to={`${process.env.PUBLIC_URL}/booking`} activeClassName='active'>Booking</Button>
      <Button className={styles.link} component={NavLink}  to={`${process.env.PUBLIC_URL}/dashboards`} activeClassName='active'>Dashboard</Button>
    </nav>
  );
};
PageNav.propTypes = {
